...
- [x] **Add `TRUST_PROXY` configuration flag**
...
- [x] **Validate cluster IDs against configured clusters**
...
- [x] **Fix CSP `unsafe-inline` or extract inline scripts**
...
- [x] **Fix `GetSnapshotByID` double query**
...
- [x] **Use connection pool ping for health check**
...
- [x] **Fix `WriteChangesCSV` redundant cluster ID parameter**
...
- [x] **Fix Collector Manager mutex inconsistency**
